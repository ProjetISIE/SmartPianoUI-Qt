...
QT_MOC_LITERAL(1, 14, 11), // "messageRecu"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 7), // "message"
QT_MOC_LITERAL(4, 35, 22), // "gererNouvelleConnexion"
QT_MOC_LITERAL(5, 58, 11) // "lireMessage"

    },
    "SocketManager\0messageRecu\0\0message\0"
    "gererNouvelleConnexion\0lireMessage"
};
...
void SocketManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->messageRecu((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->gererNouvelleConnexion(); break;
        case 2: _t->lireMessage(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketManager::messageRecu)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SocketManager::messageRecu(const QString & _t1)
{
